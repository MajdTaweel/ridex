defmodule RidexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RidexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RidexWeb.Gettext, "errors", msg, opts)
    end
  end
